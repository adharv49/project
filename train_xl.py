...
import UNet2DConditionModel as UNet2DConditionModel_ref
import StableDiffusionXLInpaintPipeline as TryonPipeline
...
def parse_args():
    ...
    parser.add_argument("--data_dir", type=str, default="/home//adharv49/Dataset/VITON-HD/zalando", help="For distributed training: local_rank")
