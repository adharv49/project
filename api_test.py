...
if __name__ == '__main__':
    client = TryOnDiffusionClient(base_url="https://try-on-diffusion.p.rapidapi.com/",api_key="dfa349584amsh9c44700e778de9dp10c6b4jsn86b8eb3b399e")
    response = client.try_on_file(
        clothing_image=cv2.imread("black-top.jpg"),
        avatar_image=cv2.imread("model.jpg"))
